...
public class InternalContainersHandler {
    ...
    public static void spawn_skeleton_head_grave(World world, BlockPos position, ArrayList<ItemStack> drop) {
        spawn_head_grave(SaveTheHotbar.SKELETON_HEAD_GRAVE, world, position, drop);
    }
    public static void spawn_zombie_head_grave(World world, BlockPos position, ArrayList<ItemStack> drop) {
        spawn_head_grave(SaveTheHotbar.ZOMBIE_HEAD_GRAVE, world, position, drop);
    }

    public static void spawn_head_grave(Block head, World world, BlockPos position, ArrayList<ItemStack> drop) {
        position = validate_position_height(world, position);
